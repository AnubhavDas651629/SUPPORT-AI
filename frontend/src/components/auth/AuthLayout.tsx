          ...
          <ol className="mt-10 max-w-md">
            {PIPELINE.map((item, i) => (
              <li key={item.step} className="relative flex gap-4 pb-8 last:pb-0">
                ...
                <span className="relative z-10 flex size-7 shrink-0 items-center justify-center rounded-full border border-line bg-surface font-mono text-[10px] font-medium text-muted">
                  {item.step}
                </span>
