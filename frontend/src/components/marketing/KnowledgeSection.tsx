    ...
    >
      ...
      <div className="mt-8 overflow-hidden rounded-panel border border-line bg-surface">
        <div className="flex flex-wrap items-center gap-2 border-b border-line px-4 py-3 sm:px-5">
          ...
          <span className="font-code text-[12.5px] text-fg">
            &ldquo;charged twice for the same invoice&rdquo;
          </span>
          <span className="ml-auto font-code text-[11px] text-subtle">3 passages</span>
        </div>
          ...
          {RESULTS.map((result) => (
            ...
            >
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                <span className="font-code text-[12px] text-fg">{result.doc}</span>
                <span className="font-code text-[11px] text-subtle">
                  chunk {result.chunk}
                </span>
                <span className="ml-auto flex items-center gap-2">
                  ...
                  <span className="font-code text-[11px] tnum text-muted">
